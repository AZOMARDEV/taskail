...
export const VerifyPhone = () => {
  ...
  const { phoneNumber, email, password, username } = params as {
    phoneNumber: string;
    email: string;
    password: string;
    username: string;
  ...
  const verifyCode = async () => {
    try {
      ...
      try {
        ...
        // You'll need to import Firestore and set up this function
        // await storeUserAdditionalData(userCredential.user.uid, {
        ...
        Toast.show({
          type: "error",
          text1: firebaseError.message || "Registration failed",
          position: "bottom",
        });
      }
    } catch (error) {
        ...
        >
          ...
          <View style={{ paddingHorizontal: 24 }}>
            <Text style={{ color: "#6B7280", marginBottom: 32 }}>
              Please enter the code we just sent to phone number {phoneNumber}
            </Text>
